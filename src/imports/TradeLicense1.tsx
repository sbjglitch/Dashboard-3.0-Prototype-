import svgPaths from "./svg-hkl0il95bp";
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[24px] items-end min-h-px min-w-px relative">
      <div className="flex-[1_0_0] h-[72px] min-h-px min-w-px relative" data-name="Input Text">
        ...
        <div className="absolute content-stretch flex inset-[87.84%_0_0_63.92%] items-start px-[4px]" data-name="Subtext" />
      </div>
      <div className="flex-[1_0_0] h-[72px] min-h-px min-w-px relative" data-name="Input Text">
        <div className="-translate-y-1/2 absolute bg-white content-stretch flex flex-col gap-[5px] items-start justify-center left-0 px-[18px] py-[16px] right-0 rounded-[8px] top-1/2" data-name="HouseName">
          <div aria-hidden="true" className="absolute border border-[#e8eff4] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)]" />
...
function Frame92() {
  return (
    <div className="bg-[#f39c13] content-stretch flex items-end justify-end px-[12px] py-[8px] relative rounded-[8px] shrink-0">
      <p className="font-sans font-bold leading-[32px] relative shrink-0 text-[24px] text-shadow-[-5px_0px_33.3px_rgba(0,0,0,0.1)] text-white whitespace-nowrap">{`IFTE&OS Licesnce, Business Facilitation​`}</p>
    </div>
  );
}
...
function Column() {
  return (
    <div className="bg-white flex-[1_0_0] h-full min-h-px min-w-px relative rounded-[8px]" data-name="Column">
      ...
      <div aria-hidden="true" className="absolute border border-[#e8eff4] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_4.883px_42px_0px_rgba(0,0,0,0.1)]" />
    </div>
  );
}
...
function Frame85() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[2px] items-start overflow-clip relative rounded-[16px] shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)] shrink-0 w-full z-[3]">
      <Frame7 />
      <Frame8 />
    </div>
  );
...
function Service() {
  return (
    <div className="bg-[#f6f9fb] relative rounded-[8px] shrink-0 w-full" data-name="Service">
      <div aria-hidden="true" className="absolute border border-[#e8eff4] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)]" />
...
function Frame102() {
  return (
    <div className="bg-white content-stretch flex gap-[16px] h-[606px] items-start p-[16px] relative rounded-[16px] shrink-0 w-[1376px] z-[1]">
...
export default function TradeLicense() {
  return (
    <div className="bg-[#e8eff4] content-stretch flex flex-col items-start relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] size-full" data-name="Trade License-1">
      <Header />
      <Frame98 />
    </div>
  );
